...
\begin{figure}
	...
	\caption{First Turret 3D Model with Parts Names}
...
Figures \ref{fig:axFrames} shows the plastic frames used to assemble the turret. Figures \ref{fig:axMounting1} and \ref{fig:axMounting2} shows how they are attached to the motor. \todo{MOVE MOUNTING INSTRUCTIONS TO APPENDIX?}
\begin{figure}
	\centering
