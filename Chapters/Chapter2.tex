...
Here we will only report the issues raised by the motors. The final solution is explained in next chapter. All other attempts are mentioned in the appendix.
