...
\begin{figure}
	\centering
	\includegraphics[width=.5\textwidth]{img/model1FrameCap.png}%
	\caption{First Turret, Reference Frames}
	\label{fig:model1FrameCap}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=.5\textwidth]{img/model1Cap.png}%
	\caption{First Turret, 3D Model with Highlighted Frames}
	\label{fig:model1Cap}
\end{figure}
