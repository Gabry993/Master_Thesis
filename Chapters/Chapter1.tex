...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{img/kgtgSetup.png}
  \captionof{figure}{Ground Robot Setup}
  \label{fig:kgtgSetup}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.58\linewidth]{img/kobukiturret.png}
  \captionof{figure}{Turret + Kobuki}
  \label{fig:mode}
\end{minipage}
\end{figure}
\begin{figure}
